...
**Audit Execution Timestamp**: 2026-09-12T09:28:41.124586Z
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `master` | `sources` | 12 | curated/verified/official | `id` | `None` |
| `master` | `dataset_versions` | 1 | official | `id` | `None` |
| `master` | `data_quality` | 4 | verified/official | `id` | `record_id` |
| `master` | `states` | 1 | official | `id` | `None` |
| `master` | `districts` | 5 | official | `id` | `state_id` |
| `master` | `blocks` | 9 | official | `id` | `district_id` |
| `master` | `villages` | 10 | official | `id` | `state_id, district_id, block_id, source_id` |
| `master` | `locations` | 8 | demo/official | `id` | `village_id, block_id, district_id, source_id` |
| `master` | `demographics` | 4 | official | `id` | `location_id, village_id, source_id` |
| `master` | `business_categories` | 8 | curated/verified | `id` | `None` |
| `master` | `businesses` | 5 | verified | `id` | `business_category_id, state_id, district_id, block_id, village_id, source_id` |
| `master` | `markets` | 4 | verified/official | `id` | `state_id, district_id, block_id, village_id, source_id` |
| `master` | `products` | 11 | verified/official | `id` | `None` |
| `master` | `prices` | 8 | verified/official | `id` | `product_id, location_id, district_id, market_id, source_id` |
...
| `master` | `business_cost_templates` | 15 | curated/estimated/verified/official | `id` | `business_template_id, source_id` |
| `master` | `business_revenue_templates` | 6 | curated/verified/official | `id` | `business_template_id, product_id, price_source_id` |
| `master` | `business_expense_templates` | 14 | curated/verified/official | `id` | `business_template_id, source_id` |
...
| `master` | `financial_references` | 5 | verified/official | `id` | `source_id` |
| `master` | `business_operating_assumptions` | 5 | curated/verified | `id` | `business_category_id, source_id` |
| `master` | `risk_rules` | 7 | curated/verified/official | `id` | `business_category_id, source_id` |
| `master` | `opportunity_rules` | 5 | curated/verified/official | `id` | `business_category_id, source_id` |
